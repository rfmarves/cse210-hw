...
public class Prompt
{
    public List<string> _promptList = new List<string>() { "Who was the most interesting person I interacted with today?", 
        ...
        "If I had one thing I could do over today, what would it be?" }; // Attribute that contains list of prompts
    ...
    // Returns a random prompt from the list of prompts attribute
    {
